...
const HeroBanner = () => {
  return (
    <Box sx={{
        ...
        <Typography fontSize='22px' lineHeight="35px" mb={3}>Checkout the most effective excercises</Typography>
        <Button variant='contained' color='error' href='#excercises' sx={{backgroundColor:'#ff2625',p:'10px'}}>Explore Excercise</Button>
